...
An automated conversion of scholarly data from the Wikidata to XML/TEI syntax applied to **Wikileopardi**'s _Canti_ collection, rendered for **EVT (Edition Visualization Technology)**. 
